...
public class SuaSachView extends JFrame{
	...
	public SuaSachView(QuanLySachView quanLySachView) {
		this.quanLySachView = quanLySachView;
	}
	
	public SuaSachView(String tieude)
	{
	...
	public void update(){
        ...
        s.setGiaTien(Double.parseDouble(txtGia.getText()));
    ...
    public void load() {
    	...
    	DefaultTableModel model = (DefaultTableModel) quanLySachView.getTblSach().getModel();
    	model.setRowCount(0);
    	for(Sach s: sachs) {
